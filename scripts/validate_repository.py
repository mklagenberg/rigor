...
REQUIRED=(
 ...
 "decisions/0006-apache-2.0-and-dco-contributions.md","decisions/0007-portable-core-and-installable-skill.md",
 ...
 "schemas/research-bundle.schema.json","templates/research-bundle.yaml","docs/executable-research-artifacts.md",
 ...
 "skills/rigor/references/activation.md","skills/rigor/references/orchestration.md","skills/rigor/references/artifacts.md","skills/rigor/references/host-capabilities.md",
 "skills/rigor/assets/research-bundle.json","skills/rigor/scripts/validate_bundle.py",
 "tests/fixtures/valid-research-bundle.json","tests/fixtures/invalid-unknown-citation.json"
)
...
def main():
 ...
 for t in ('compatibility: "^1.0.0"','kind: "methodology"','version: "0.1.0"','license: "Apache-2.0"','lifecycle: "embedded"','role: "installable-orchestration-skill"'): require(t in moda,f"moda.yaml missing {t}")
